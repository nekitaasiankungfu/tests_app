...
- **15 psychological tests organized in 5 categories:**
  ...
  - 🌟 **Эмоциональное состояние:** Stress Test, Self-Esteem Test, Digital Detox (50 q), Burnout Diagnostic (54 q), Color Psychology (6 stages)
  - 💼 **Карьера:** Holland Code RIASEC (60 q), **Career Compass (56 forced_choice)** ⭐ NEW
...
**Codebase State:** ~42,000+ lines across 84+ files (+305% growth since v1.0.0)
...
**Psychological Tests:** 15 tests across 5 categories
  ...
  - 2 special tests:
    ...
    - Career Compass (56 forced_choice questions, 8 career scales) ⭐ NEW
**Architecture Status:** Production-ready with dual architecture support
**Test Architecture:** 13 Legacy Dart + 2 Special = 15 total tests
**Recent Updates:**
- Career Compass Test добавлен (v3.14.0) ⭐ NEW - forced_choice парные сравнения
- 7 новых файлов: model, data, widget, service, 2 screens, test stub
- Bug fix: maxScaleScore = (questions × 2) / scales
- ADDING_SPECIAL_TESTS.md (v1.2.0) - добавлен Forced Choice раздел
- Documentation v3.2.0 - два типа специальных тестов
